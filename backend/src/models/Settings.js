...
const settingsSchema = new mongoose.Schema(
  {
    ...
    deliveryAreas: {
      ...
      default: [
        { name: 'Benz Circle', isActive: true },
        { name: 'Patamata', isActive: true },
        { name: 'Labbipet', isActive: true },
        { name: 'Auto Nagar', isActive: true },
        { name: 'Governorpet', isActive: true },
        { name: 'Suryaraopet', isActive: true },
      ],
    },
    socialLinks: {
      instagram: String,
